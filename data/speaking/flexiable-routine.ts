...
export const FlexibleRoutine = {
    name: 'Would you rather have a stable routine or a flexible one?',
    description: '',
    mode: 'flashcards',
    sentences: [
        {
        ...
        {
            english: "And honestly, I can understand that point of view",
            translation: "can understand",
