...
import { Layers, PenTool, ArrowLeft, Mic } from 'lucide-react';
...
const SpeakingView: React.FC<SpeakingViewProps> = ({ onSelectLevel, onBack }) => {
  ...
  return (
    <div className="min-h-screen max-w-7xl bg-black flex flex-col p-6 mx-auto w-full">
      {/* Header */}
      <div className="flex items-center mb-10 pt-4 gap-4">
        <button
          onClick={onBack}
